...
class MapViewModel @Inject constructor() : ViewModel() {
    ...
    init {
        ...
        _placeList.value = listOf(
            MapPlaceEntity(1, "국립현대미술관",1,"용산구", listOf(1,2), 37.5374729285246, 126.965664771338),
            MapPlaceEntity(2, "서울아산병원",2, "송파구", listOf(3,4), 37.5054870414361, 127.083121066144),
            MapPlaceEntity(3, "숙명여자대학교",1,"용산구", listOf(1,2,3), 37.5429793370245, 126.971946055378),
            MapPlaceEntity(4, "국립현대미술관",1, "용산구", listOf(1,2), 37.5425431587763, 126.973487034748),
            MapPlaceEntity(5, "서울아산병원",1, "마포구", listOf(3,4),37.5456041859389, 126.955194223342),
            MapPlaceEntity(6, "숙명여자대학교",2, "관악구", listOf(1,2,3), 37.475339578085, 126.981089942431),
            MapPlaceEntity(7, "국립현대미술관",2, "마포구", listOf(1,2), 37.5549789202685, 126.930036332426),
            MapPlaceEntity(8, "서울아산병원",2, "관악구",  listOf(1,2,3), 37.474629606862, 126.952599252174),
            MapPlaceEntity(9, "숙명여자대학교",2, "강서구", listOf(1,2), 37.555567479084, 126.854371723846),
            MapPlaceEntity(10, "국립현대미술관",2, "강서구", listOf(1,2,3), 37.555567479085, 126.854371723847),
            MapPlaceEntity(11, "서울아산병원",2, "송파구", listOf(3,4), 337.5054870414361, 127.083121066144),
        )
    }
