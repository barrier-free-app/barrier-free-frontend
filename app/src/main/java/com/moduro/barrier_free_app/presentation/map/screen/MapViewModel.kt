...
class MapViewModel @Inject constructor() : ViewModel() {
    ...
    init {
        ...
        _placeList.value = listOf(
            MapPlaceEntity(1, "더미 1",1,"용산구", listOf("영유아 동반", "승강기"), 37.5374729285246, 126.965664771338),
            MapPlaceEntity(2, "더미 2",2, "송파구", listOf("장애인 화장실", "수유실"), 37.5054870414361, 127.083121066144),
            MapPlaceEntity(3, "더미 3",1,"용산구", listOf("경사로", "장애인 화장실", "수유실", "영유아 동반"), 37.5429793370245, 126.971946055378),
            MapPlaceEntity(4, "더미 4",1, "용산구", listOf("장애인 화장실", "수유실"), 37.5425431587763, 126.973487034748),
            MapPlaceEntity(5, "더미 5",1, "마포구", listOf("경사로", "장애인 화장실", "수유실", "영유아 동반"),37.5456041859389, 126.955194223342),
            MapPlaceEntity(6, "더미 6",2, "관악구", listOf("장애인 화장실", "수유실"), 37.475339578085, 126.981089942431),
            MapPlaceEntity(7, "더미 7",2, "마포구", listOf("경사로", "장애인 화장실", "수유실", "영유아 동반"), 37.5549789202685, 126.930036332426),
            MapPlaceEntity(8, "더미 8",2, "관악구",  listOf("장애인 화장실", "수유실"), 37.474629606862, 126.952599252174),
            MapPlaceEntity(9, "더미 9",2, "강서구", listOf("경사로", "장애인 화장실", "수유실", "영유아 동반"), 37.555567479084, 126.854371723846),
            MapPlaceEntity(10, "더미 10",2, "강서구", listOf("장애인 화장실", "수유실"), 37.555567479085, 126.854371723847),
            MapPlaceEntity(11, "더미 11",2, "송파구", listOf("경사로", "장애인 화장실", "수유실", "영유아 동반"), 337.5054870414361, 127.083121066144),
        )
    }
