...
@Serializable
data class ResponseFavoritePlacesResultDto(
    @SerialName("mapFavorites") val mapFavorites: List<ResponseFavoritePlaceDto>,
    @SerialName("reportFavorites") val reportFavorites: List<ResponseFavoritePlaceDto>
)
