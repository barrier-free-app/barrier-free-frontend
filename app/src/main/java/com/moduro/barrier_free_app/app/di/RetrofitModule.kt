...
object RetrofitModule {
    ...
    @Provides
    @ModuroRetrofit
    fun provideRetrofit(@Named("appClient") okHttpClient: OkHttpClient): Retrofit = Retrofit.Builder()
    ...
    @Provides
    @AirKoreaRetrofit
    fun provideAirKoreaRetrofit(@Named("airKoreaClient") okHttpClient: OkHttpClient, json: Json): Retrofit {
